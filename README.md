...
| File | Topics Covered |
|------|---------------|
| [01_python_basics_variables.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/01_python_basics_variables.py) | print(), variables, arithmetic, string basics |
| [02_datatypes_typecasting.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/02_datatypes_typecasting.py) | int, float, str, bool, complex, type(), type casting |
| [03_operators_&_conditionals.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/03_operators_%26_conditionals.py) | all operators, if/elif/else, nested conditions |
| [04_loops_&_iteration.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/04_loops_%26_iteration.py) | while, for, range(), break, continue |
| [05_lists_&_tuples.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/05_lists_%26_tuples.py) | indexing, slicing, list methods, tuples, conversions |
| [06_strings_sets_dictionaries.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/06_strings_sets_dictionaries.py) | string methods, sets, set operations, dictionaries |
| [07_dictionaries_functions.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/07_dictionaries_functions.py) | nested dicts, user-defined functions, parameters, return |
| [08_lambda_functions.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/08_lambda_functions.py) | lambda, map(), filter(), sorted() with custom keys |
| [Python_assignment_questions.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/Python_assignment_questions.py) | 20 practice problems across all basics topics |
| [Python_assignments_answers.py](https://github.com/Abhirai2006/daily-code/blob/main/Python/Basics/Python_assignments_answers.py) | solutions with comments and explanations |
...
Made by [Abhirai2006](https://github.com/Abhirai2006) — feel free to explore, learn, or suggest improvements via Issues.